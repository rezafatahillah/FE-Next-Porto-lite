...
import { ACCESS_ROLE_BREADCRUMB } from "../../enums";
import { AccessRoleTable } from "../tables";

// ----------------------------------------------------------------------

interface Props {}

export function AccessRoleListView(props: Props) {
  const {} = props;
  ...
  return (
    <>
      <DashboardContent>
        <CustomBreadcrumbs
          heading="List"
          links={ACCESS_ROLE_BREADCRUMB}
          action={
            <Button
              component={RouterLink}
              href={paths.backOffice.accounts.configs.roles.create}
              variant="contained"

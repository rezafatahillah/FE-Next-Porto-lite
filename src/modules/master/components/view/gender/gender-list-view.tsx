...
import { GENDER_BREADCRUMB } from "../../../enums";
import { GenderTable } from "../../tables";

// ----------------------------------------------------------------------

interface Props {}

export function GenderListView(props: Props) {
  const {} = props;
  ...
  return (
    <>
      <DashboardContent>
        <CustomBreadcrumbs
          heading="List"
          links={GENDER_BREADCRUMB}
          action={
            <Button
              component={RouterLink}
              href={paths.backOffice.master.gender.create}
              variant="contained"

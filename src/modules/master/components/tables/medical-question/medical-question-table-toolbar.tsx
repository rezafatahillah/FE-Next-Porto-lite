...
import { useMedicalQuestionFilter } from "../../../hooks";
...
export function MedicalQuestionTableToolbar(props: Props) {
  const { rowCount } = props;

  const { keyword, canReset, onReset } = useMedicalQuestionFilter();

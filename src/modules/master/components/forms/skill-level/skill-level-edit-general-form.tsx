...
import { useSkillLevelUpdate } from "../../../hooks";
...
export function SkillLevelEditGeneralForm(props: Props) {
  const { id, current, onSuccess } = props;

  const { activeFile, onUploading, methods, onSubmit, isLoading } = useSkillLevelUpdate({
    id,
    current,
    onSuccess,
  });

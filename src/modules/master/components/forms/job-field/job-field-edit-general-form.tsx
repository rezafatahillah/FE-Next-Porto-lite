...
import { useJobFieldUpdate } from "../../../hooks";
...
interface Props extends IFeedbackFormProps {
  ...
  current?: IJobFieldEntity;
}

export function JobFieldEditGeneralForm(props: Props) {
  const { id, current, onSuccess } = props;

  const { activeFile, onUploading, methods, onSubmit, isLoading } = useJobFieldUpdate({
    id,
    current,
    onSuccess,
  });

...
import { useMaritalStatusUpdate } from "../../../hooks";
...
interface Props extends IFeedbackFormProps {
  ...
  current?: IMaritalStatusEntity;
}

export function MaritalStatusEditGeneralForm(props: Props) {
  const { id, current, onSuccess } = props;

  const { activeFile, onUploading, methods, onSubmit, isLoading } = useMaritalStatusUpdate({
    id,
    current,
    onSuccess,
  });

...
import { useDiseaseUpdate } from "../../../hooks";
...
export function DiseaseEditGeneralForm(props: Props) {
  const { id, current, onSuccess } = props;

  const { activeFile, onUploading, methods, onSubmit, isLoading } = useDiseaseUpdate({
    id,
    current,
    onSuccess,
  });

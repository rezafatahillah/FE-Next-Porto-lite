...
import { TaxUpdateSchema } from "../../../schemes";
...
export const useTaxUpdate = (props: Props) => {
  ...
  const methods = useForm({
    mode: "onChange",
    resolver: yupResolver(TaxUpdateSchema),
    defaultValues: {
      name: "",
    },
  });
  ...
  const mutation = TaxQuery.useUpdate({});

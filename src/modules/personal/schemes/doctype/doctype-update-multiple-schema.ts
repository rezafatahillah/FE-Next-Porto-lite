...
export const DoctypeUpdateMultipleSchema = object().shape({
  doctypes: array(
    object()
      .shape({
...
export interface IDoctypeUpdateMultipleSchema
  extends InferType<typeof DoctypeUpdateMultipleSchema> {}

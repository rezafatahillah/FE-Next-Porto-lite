...
export const EducationUpdateMultipleSchema = object().shape({
  formals: array(
    object()
      .shape({
        id: number().required(),
...
export interface IEducationUpdateMultipleSchema
  extends InferType<typeof EducationUpdateMultipleSchema> {}

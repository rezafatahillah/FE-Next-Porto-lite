...
export const WorkCreateSchema = object().shape({
  ...
  start: string()
    .required("Mulai kerja wajib diisi"),
...
export interface IWorkCreateSchema extends InferType<typeof WorkCreateSchema> {}

...
// import { CandidateTableToolbar } from "./candidate-table-toolbar";
// import { CandidateTableRow } from "./candidate-table-row";
// import { CandidateQuery, useCandidateFilter, useCandidateDelete } from "../../../hooks";
...
//   const { queries } = useCandidateFilter();

//   const table = useTableParams();

//   const { data, isFetching, refetch } = CandidateQuery.useGetAll({
//     props: {
//       params: {
//         ...queries,
//         ...table.params,
...
//   const { onSubmit: onDeleteRow } = useCandidateDelete({
//     onSuccess: () => {
//       refetch();
//     },
//   });
...
//   return (
//     <>
//       <CandidateTableToolbar rowCount={rowCount} />

...
import { MedicalTableToolbar } from "./medical-table-toolbar";
import { MedicalTableRow } from "./medical-table-row";
import { MedicalQuery, useMedicalFilter, useMedicalDelete } from "../../../hooks";

// ----------------------------------------------------------------------

const TABLE_HEAD = [
  { id: "medical", label: "Medical" },
  { id: "medicallevel", label: "Level" },
...
export function MedicalTable(props: Props) {
  const {} = props;

  const confirm = useBoolean();

  const { queries } = useMedicalFilter();

  const table = useTableParams();

  const { data, isFetching, refetch } = MedicalQuery.useGetAll({
    props: {
      params: {
        ...queries,
        ...table.params,
  ...
  return (
    <>
      <MedicalTableToolbar rowCount={rowCount} />

...
export function MedicalTableRow(props: Props) {
  const { row, selected, onSelectRow, onDeleteRow } = props;

  const { id, diseaseId, answer} = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell>
          <Stack spacing={2} direction="row" alignItems="center"><ListItemText primary={diseaseId.name} /></Stack>
        </TableCell>
        <TableCell>
          <Stack spacing={2} direction="row" alignItems="center"><ListItemText primary={answer.name} /></Stack>
        </TableCell>

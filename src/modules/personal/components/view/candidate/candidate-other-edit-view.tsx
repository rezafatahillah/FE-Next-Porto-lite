...
import { CANDIDATE_OTHER_EDIT_BREADCRUMB } from "../../../enums";
import { CandidateQuery } from "../../../hooks";
import { CandidateEditOtherForm } from "../../forms";
...
export function CandidateOtherEditView() {
  ...
  return (
    <DashboardContent>
      <CustomBreadcrumbs
        heading="Edit"
        links={CANDIDATE_OTHER_EDIT_BREADCRUMB(id, current?.accountName)}
        sx={{
          mb: { xs: 3, md: 5 },
        }}
      />

  ...
  const renderList = (
    <Scrollbar
      onScrollCapture={(event: any) => {
        const { scrollTop, scrollHeight, skillHeight } = event.target;
        const isScrolledBottom = scrollHeight - scrollTop === skillHeight;
      ...
      <DialogTitle sx={{ pb: 0 }}>
        ...
        >
          ...
          <Button
            ...
            href={paths.backOffice.personal.skill.create}
            target="_blank"
            size="small"
            variant="text"

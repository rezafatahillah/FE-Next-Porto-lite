...
import { useWorkCreate } from "../../../hooks";

// ----------------------------------------------------------------------

interface Props {}

export function WorkCreateForm(props: Props) {
  const {} = props;
  ...
  const { methods, onSubmit, isLoading } = useWorkCreate({});
            ...
            <Stack direction="row" spacing={2} alignItems="center">
              ...
              {!stillWorking && (
                <Field.DatePicker
                  ...
                  //       .startOf("month")
                  //       .format("YYYY-MM-DD");
                  //     methods.setValue("end", formattedValue);
                  //   }
                  // }}
                  sx={{ flex: 1 }}
                />

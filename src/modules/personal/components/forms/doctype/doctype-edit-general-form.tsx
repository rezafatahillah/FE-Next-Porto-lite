...
import { useDoctypeUpdate } from "@/modules/personal/hooks";
import { IDoctypeEntity } from "@/modules/personal/entities";
import { CodeQuery } from "@/modules/personal/hooks";

// ----------------------------------------------------------------------



export function DoctypeEditGeneralForm() {

  const { methods, onSubmit, isLoading } = useDoctypeUpdate();
